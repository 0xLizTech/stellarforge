...
- `docs/audits/2026-09-14-internal-review-phase1.md`, the Phase 1 internal security review of all four contracts, the SDK and the deployment/CI tooling. IR-01 to IR-07 are fixed; the rest are open.
